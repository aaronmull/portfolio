...
const contactInfo = [
    {
        ...
        value: "aaronmull421@gmail.com",
        href: "mailto:aaronmull421@gmail.com"
    },
    {
        icon: Mail,
        label: "Rowan Email",
    ...
    },
    {
        icon: Phone,
        label: "Phone",
        value: "+1 (609) 742-8159",
        href: "tel:+16097428159",
    },
    {
        icon: MapPin,
        label: "Location",
        value: "Hammonton, NJ; Glassboro, NJ",
        href: "#",
    },
]
export const Contact = () => {
    ...
    return (
        <section id="contact" className="py-32 relative overflow-hiden">
                ...
                <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
                    ...
                    <div className="space-y-6 animate-fade-in animation-delay-400">
                        ...
                        <p className="text-muted-foreground text-sm">
                            I'm open to any new opportunities and exciting projects.
                            If you need an engineering intern, assistant, or a project contributor, let's talk!
                        </p>
                        </div>
                    </div>
                </div>
