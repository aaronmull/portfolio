...
const socialLinks = [
  { icon: LinkedinIcon, href: "https://www.linkedin.com/in/aaron-mull-91369b334/", label: "LinkedIn" },
  { icon: GithubIcon, href: "https://github.com/aaronmull", label: "GitHub" },
];
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              © {currentYear} Aaron Mull. All rights reserved.
            </p>
          </div>
